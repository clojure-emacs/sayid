...
The `core` namespace is designed to be used directly via a repl and does
...
[GitHub Repo](http://github.com/clojure-emacs/sayid)
...
::: {#footer .site-footer}
::: {.wrap}
Copyright (c) [Bill Piel](http://billpiel.com), 2016.
:::
:::
:::
